...
/// Null when healthy.
 String? get healthNote;/// True when the last explicit user operation (switch / Quick Connect)
...
@useResult
$Res call({
 ConnPhase phase, String message, DialParams? dial, String? regionId, String? serverId, bool explicitTarget, DeviceStatus? deviceStatus, DateTime? lastStatusAt, int pollFailures, VpnStage? lastStage, int? rxBytes, int? txBytes, String? healthNote, bool opFailed, int autoHealAttempts, int autoFailoverAttempts
});
...
as String?,opFailed: null == opFailed ? _self.opFailed : opFailed // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ConnPhase phase,  String message,  DialParams? dial,  String? regionId,  String? serverId,  bool explicitTarget,  DeviceStatus? deviceStatus,  DateTime? lastStatusAt,  int pollFailures,  VpnStage? lastStage,  int? rxBytes,  int? txBytes,  String? healthNote,  bool opFailed,  int autoHealAttempts,  int autoFailoverAttempts)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ConnState() when $default != null:
return $default(_that.phase,_that.message,_that.dial,_that.regionId,_that.serverId,_that.explicitTarget,_that.deviceStatus,_that.lastStatusAt,_that.pollFailures,_that.lastStage,_that.rxBytes,_that.txBytes,_that.healthNote,_that.opFailed,_that.autoHealAttempts,_that.autoFailoverAttempts);case _:
  return orElse();
...
class _ConnState implements ConnState {
  const _ConnState({this.phase = ConnPhase.idle, this.message = '', this.dial, this.regionId, this.serverId, this.explicitTarget = false, this.deviceStatus, this.lastStatusAt, this.pollFailures = 0, this.lastStage, this.rxBytes, this.txBytes, this.healthNote, this.opFailed = false, this.autoHealAttempts = 0, this.autoFailoverAttempts = 0});
...
@override
int get hashCode {
    return Object.hash(runtimeType,phase,message,dial,regionId,serverId,explicitTarget,deviceStatus,lastStatusAt,pollFailures,lastStage,rxBytes,txBytes,healthNote,opFailed,autoHealAttempts,autoFailoverAttempts);
}

@override
String toString() {
    return 'ConnState(phase: $phase, message: $message, dial: $dial, regionId: $regionId, serverId: $serverId, explicitTarget: $explicitTarget, deviceStatus: $deviceStatus, lastStatusAt: $lastStatusAt, pollFailures: $pollFailures, lastStage: $lastStage, rxBytes: $rxBytes, txBytes: $txBytes, healthNote: $healthNote, opFailed: $opFailed, autoHealAttempts: $autoHealAttempts, autoFailoverAttempts: $autoFailoverAttempts)';
}
